...
- [Yew](https://github.com/jetli/awesome-yew#readme) - Rust / Wasm framework inspired by Elm and React for creating multi-threaded frontend web apps with WebAssembly.
