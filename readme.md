...
- [Microsoft Agent Framework](https://github.com/webmaxru/awesome-microsoft-agent-framework#readme) - Open-source development kit for building AI agents and multi-agent workflows.
