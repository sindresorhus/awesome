...
- [AI Agent Tools](https://github.com/michielhdoteth/awesome-ai-agent-tools#readme) - Installable skills, MCP servers, agent workflows, subagents, hooks, plugins, prompts, and CLI tools for AI coding assistants.
