...
- [Imba](https://github.com/koolamusic/awesome-imba#readme) - Heavily inspired by Ruby and Python, but developed explicitly for web programming and compiles to performant JavaScript.
