...
- [Database tools](https://github.com/mgramin/awesome-db-tools#readme) - List of database tools (IDE, CLI, managing, monitoring, migrations, modelers, visualization etc).
