...
- [Marmo UI](https://github.com/mahmoudilyan/marmoui#readme) - Marmo gives Claude Code, Codex, Cursor and Gemini CLI a real design system over MCP — component APIs, composition patterns, and your own tokens.
