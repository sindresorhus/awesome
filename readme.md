...
- [Neuromorphic or Spiking Networks](https://github.com/artiomn/awesome-neuromorphic#readme) - Spiking or neuromorphic neural networks are artificial neural networks that more closely mimic natural neural networks.
