...
- [Web Performance Budget](https://github.com/pajaydev/awesome-performance-budget#readme) - Techniques to set and maintain pre-defined performance metrics for our page.
