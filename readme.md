...
- [LazyCat Microserver](https://github.com/mxuexxmy/awesome-lazycat-microserver#readme) - Home private cloud appliance with NAS features, app marketplace, and local AI compute.
