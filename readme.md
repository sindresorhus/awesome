...
- [Agent Evolution](https://github.com/EvoMap/awesome-agent-evolution#readme) - AI Agent self-evolution, memory systems, multi-agent collaboration, and autonomous self-improvement.
