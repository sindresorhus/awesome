...
- [Copilot Instructions](https://github.com/Code-and-Sorts/awesome-copilot-instructions#readme) - Instruction and prompt files for customizing GitHub Copilot’s AI agent and chat behavior across workflows.
