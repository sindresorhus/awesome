...
- [Vibe Coding](https://github.com/taskade/awesome-vibe-coding#readme) - Building software through natural language prompts, using AI to generate, test, and deploy code.
