...
- [Supabase](https://github.com/lyqht/awesome-supabase) - An open source alternative to Firebase that provides a Postgres database, Authentication, instant APIs, Edge Functions, Realtime subscriptions, and Storage.
