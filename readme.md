...
- [Fuzzing](https://github.com/cpuu/awesome-fuzzing#readme) - Tools and techniques for testing applications by feeding them pseudo-randomly generated input data.
