...
- [Executable Packing](https://github.com/dhondta/awesome-executable-packing) - Research resources, packers, unpackers and detection tools for various executable formats (PE, ELF, ...).
