...
- [Open Hardware](https://github.com/delftopenhardware/awesome-open-hardware#readme) - physical artifacts whose designs are shared publicly so that others can make, modify, distribute and use those things.
