...
- [Decentralized Science](https://github.com/DeSciWorldDAO/awesome-desci) - Descentralized Science: science meets blockchain to solve issues related to funding, publishing, data validation and sharing.
