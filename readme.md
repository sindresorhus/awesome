...
- [Nix](https://github.com/nix-community/awesome-nix#readme) - Nix is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
