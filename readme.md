...
- [Speech and Natural Language Processing](https://github.com/edobashira/speech-language-processing#readme)
	...
	- [Natural Language Generation](https://github.com/tokenmill/awesome-nlg#readme) - Automated creation of natural language text, used to convert data to text, response generation for conversational agents, or create narratives for reports, news items and a like.
