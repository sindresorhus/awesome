...
- [Agent Protocols](https://github.com/shanjairaj7/awesome-agent-protocols#readme) - Protocols, SDKs, and tools for AI agent communication — email, SMS, MCP, webhooks, and inter-agent messaging.
