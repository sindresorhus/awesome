...
- [Contexture](https://github.com/ltchris/awesome-contexture) - Abstracting queries/filters and results/aggregrations from different backing data stores like ElasticSearch and MongoDB.
