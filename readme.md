...
- [Substrate](https://github.com/substrate-developer-hub/awesome-substrate#readme) - Framework for writing scalable, upgradeable blockchains in Rust; crafted with ❤️ by [Parity Technologies](https://github.com/paritytech).
