...
- [Coq](https://github.com/coq-community/awesome-coq#readme) - Formal language and environment for programming and specification that facilitates the interactive development of machine-checked proofs.
