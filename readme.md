...
- [Processing](https://github.com/zakarialaoui10/awesome-processing#readme) - Simple programming environment created to make it easier to develop visually oriented applications with an emphasis on animation and interaction.
