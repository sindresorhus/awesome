...
- [Quarto](https://github.com/mcanouil/awesome-quarto#readme) - Quarto® is an open-source scientific and technical publishing system built on Pandoc, allowing computations using Jupyter or R/knitr.
