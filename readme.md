...
- [NativeScript](https://github.com/dyazincahya/awesome-nativescript#readme) - Empower JavaScript with native APIs. Build native apps for iOS, Android, and VisionOS — entirely in JavaScript.
