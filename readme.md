...
- [Prompt Injection](https://github.com/FonduAI/awesome-prompt-injection#readme) - Learn about a type of vulnerability that specifically targets machine learning models 
